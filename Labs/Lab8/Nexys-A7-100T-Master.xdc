...
##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { playSound }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[0]
...
# -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { S[2] }]; #IO_L17N_T2_A25_15 Sch=led[2]
